...
\textbf{to}\\
 ...
 \vspace{0.2cm}\hspace{0.3cm}\includegraphics[scale=0.6]{ktu.png} \\
...
\begin{table}[H]
    \centering
    \begin{tabular}{|>{\centering\arraybackslash}m{6cm}|>{\centering\arraybackslash}m{6cm}|>{\centering\arraybackslash}m{5cm}|}
        \hline
