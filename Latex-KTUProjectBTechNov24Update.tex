...
\textbf{to}\\
 ...
 \vspace{0.2cm}\hspace{0.3cm}\includegraphics[scale=0.3]{ktu.png} \\
...
\includegraphics[scale=0.06]{cape.png}
...
\begin{flushleft}
	\begin{figure}[H]
		...
		\includegraphics[scale=0.31]{1.jpeg}  
		\caption{} % Description above the image   
	\end{figure}
